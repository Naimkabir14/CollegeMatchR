...
def college_selection(state):
    ...
    for item in lst_of_school.findAll('li'):
        try:
            ...
            universities.setdefault(state, {}).update({schools:[{'Location':location,'School Type':school_type,'Acceptance Rates':acceptance_rates,'SAT Score Range':test_scores}]})
    ...
    def more_data(universities, lst, state):
        ...
        for school in lst:
            ...
            try:
                ...
                universities[state][school][0].update({'School Rank': school_rank})
                ...
                for info in content_placeholder:
                    if 'Number of Students' in info.text:
                        ...
                        universities[state][school][0].update({'Student Size': student_size})
                    ...
                    if 'No. of students per staff' in info.text:
                        ...
                        universities[state][school][0].update({'Students Per Staff': students_per_staff})
                    ...
                    if 'Percentage of International Students' in info.text:
                        ...
                        universities[state][school][0].update({'International Student Percentage': international_student_percentage})
                    ...
                    if 'Student Ratio of Females to Males' in info.text:
                        ...
                        universities[state][school][0].update({'Male to Female Ratio': male_to_female_ratio})
                    ...
                    if 'Out-of-state Tuition and Fees' in info.text:
                        ...
                        universities[state][school][0].update({'Out of State Tuition': out_of_state_tuition})
                    ...
                    if 'On-campus Room and Board' in info.text:
                        ...
                        universities[state][school][0].update({'In-State Tuition': on_campus_tuition})
                    ...
                    if 'Salary after 10 years' in info.text:
                        ...
                        universities[state][school][0].update({'Salary After 10 Years': salary_post_ten_years})
